...
import {PlayCircled} from 'emissary/src/js/components/icons';
  ...
  render() {
    return (
      <div className={style.outer}>
        {!this.state.show && <Button secondary="true" onClick={this.handleButtonClick} className={style.button}>Watch the video&nbsp;<PlayCircled btn/></Button>}
